...
import { listProductDetails, updateProduct } from '../../actions/eShopActions/productActions'
import { PRODUCT_UPDATE_RESET } from '../../constants/eShopConstants/productConstants'
...
const ProductEditScreen = ({ match, history }) => {
  ...
  useEffect(() => {
    if (successUpdate) {
      ...
      history.push('/adminEshop/productlists')
    } else {
