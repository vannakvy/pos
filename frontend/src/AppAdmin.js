  ...
  return (
    <Router>
      <div className="d-flex position-relative">
        <div
          className="overflow-auto px-2 py-2 border-right border-bottom d-none d-lg-block"
          style={{
            minWidth: "250px",
            height: "94vh",
            position: "sticky",
        ...
        <div className="w-100 mx-1" style={{ minHeight: "100vh" }}>
          <Switch>
            ...
            <Route
              path="/adminEbook/contents"
              component={AddminContentScreen}
            />
            <Route
              path="/adminEbook/details/:id"
              component={AddminDetailScreen}
            />
            ...
            />
            <Route
              path="/adminEshop/productLists/:pageNumber"
              component={Stock}
            />
