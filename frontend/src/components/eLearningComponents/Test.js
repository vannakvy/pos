        ...
        >
         <div className="px-5 pt-4 rounded shadow-sm bg-light">
          ...
          <p className="text-dark kh fw-bold" style={{ lineHeight: 1.8 }}>
           ...
           នៅក្នុងផ្នែកនេះដែរ​
           យើងនឹងបង្រៀនសរសេរកូដក្នុងការបង្កើតកម្មវិធីកុំព្យូទ័រតាំងពីថ្នាក់ដំបូង
           រហូតដល់ស្ទាត់ជំនាញ។​
        ...
        >
         <div className="px-5 pt-4 rounded shadow-sm bg-light">
          ...
          <p className="text-dark kh fw-bold" style={{ lineHeight: 1.8 }}>
           <span className="me-5"></span>
           នៅក្នុងផ្នែកនេះដែរ
           យើងនឹងបង្រៀនសរសេរកូដក្នុងការបង្កើតកម្មវិធីនៅលើទូរស័ព្ទតាំងពីថ្នាក់ដំបូង
           រហូតដល់ស្ទាត់ជំនាញ។​
           ហើយការរៀនមានផ្នែកមួយៗដ់ើម្បីឲ្យសិស្សានុសិស្សងាយយល់
           និងអាចឆាប់ចេះបង្កើតកម្មវិធីដោយខ្លួនឯងបាន។
          </p>
        ...
        >
         <div className="px-5 pt-4 rounded shadow-sm bg-light">
          ...
          <p className="text-dark kh fw-bold" style={{ lineHeight: 1.8 }}>
           <span className="me-5"></span>
           នៅក្នុងផ្នែកនេះដែរ
           យើងនឹងបង្រៀនសរសេរកូដក្នុងការបង្កើតគេហៈទំព័រតាំងពីថ្នាក់ដំបូង
           រហូតដល់ស្ទាត់ជំនាញ។​
           ហើយការរៀនមានផ្នែកមួយៗដ់ើម្បីឲ្យសិស្សានុសិស្សងាយយល់
           និងអាចឆាប់ចេះបង្កើតកម្មវិធីដោយខ្លួនឯងបាន។
          </p>
        ...
        >
         <div className="px-5 pt-4 rounded shadow-sm bg-light">
          ...
          <p className="text-dark kh fw-bold" style={{ lineHeight: 1.8 }}>
           <span className="me-5"></span>
           នៅក្នុងផ្នែកនេះដែរ​
           យើងនឹងបង្រៀនសរសេរកូដក្នុងការបង្កើតប្រព័ន្ធបញ្ជា​(Board)
