...
const getDetailByContentId = asyncHandler(async(req,res)=>{
    const details = await eBookContent.findOne({_id:req.params.id}).populate('details');
...
export {getDetail,addDetail,deleteDetail,updateDetail,getOneDetail,getDetailByContentId};