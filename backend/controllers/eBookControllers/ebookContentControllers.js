...
const getContentByLang = asyncHandler(async(req,res)=>{
    ...
    if(req.params.id==="languages"){
        ...
        const {contents}= await eBookCourse.findOne({'title':req.params.id}).populate('contents');
...
export {getContentByLang, getContents, updateContent, deleteContent,addContent}